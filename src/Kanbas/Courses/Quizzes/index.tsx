            ...
            {quiz.published ? <GreenCheckmark /> : <RedBan />}
              <div className="dropdown">
                ...
                <ul className="dropdown-menu" aria-labelledby="quizMenuButton">
                 <li>
        <a className="dropdown-item" href="#" onClick={() => handleEdit(quiz._id)}>Edit</a>
    </li>
    <li>
        <a className="dropdown-item" href="#" onClick={() => handleDelete(quiz._id)}>Delete</a>
    </li>
    <li>
        <a className="dropdown-item" href="#" onClick={() => togglePublishStatus(quiz._id, quiz.published)}>Publish/Unpublish</a>
    </li>
                </ul>
             </div>
            </div>
